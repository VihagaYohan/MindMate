...
// icon
import { House, NotebookPen, Laugh, UserRound } from 'lucide-react-native'
        ...
        <Tab.Navigator initialRouteName={Routes.home} screenOptions={{
            ...
            <Tab.Screen name={Routes.home} component={HomePage} options={{
                ...
                tabBarLabel: ({ focused, color }) => (
                    focused ? <AppText text='Home' textStyle={{ ...styles.labelStyle, color: color }} /> : null
                ),
            ...
            <Tab.Screen name={Routes.settings} component={SettingsPage} options={{
                tabBarIcon: ({ focused, color, size }) => (
                    <View style={{
                        justifyContent: "center",
                        alignItems: "center"
                    }}>
                        <UserRound color={focused ? Colors.primaryCore : color} size={size} />
                    </View>
                ),
                tabBarLabel: ({ focused, color }) => (
                    focused ? <AppText text='Profile' textStyle={{ ...styles.labelStyle, color: color }} /> : null
                ),
                tabBarLabelPosition: 'beside-icon'
            }} />
        </Tab.Navigator>
